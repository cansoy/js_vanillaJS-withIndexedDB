const cleanHtmlDocWindow=()=>{
    orderMoreDetailInner.forEach(item=>{item.textContent=""})
    siparisAciklamasiInnerBody.innerHTML=""
    siparisTeyitVerenlerInnerBody.innerHTML=""
    siparisIsyerikoduInnerBody.innerHTML=""
